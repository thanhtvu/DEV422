...
builder.Services.AddScoped<IPerfomanceStatsRepository, PerfomanceStatsRepository>();
#endregion
#region [ DI Services ]
builder.Services.AddScoped<IPermonaceStatsService, PerfomanceStatsService>();
#endregion
#if DEBUG
